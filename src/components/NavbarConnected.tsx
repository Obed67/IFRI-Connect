      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-lg p-4 space-y-4">
          ...
          <div className="space-y-2">
            <Link to="/dashboard" onClick={handleNavigate} className="block text-gray-600 hover:text-blue-600 transition-colors duration-200">
              <LayoutDashboard className="h-5 w-5 inline mr-2" /> Tableau de bord
            </Link>
            <Link to="/profile" onClick={handleNavigate} className="block text-gray-600 hover:text-blue-600 transition-colors duration-200">
              <User className="h-5 w-5 inline mr-2" /> Mon profil
            </Link>
            <Link to="/setting" onClick={handleNavigate} className="block text-gray-600 hover:text-blue-600 transition-colors duration-200">
              <Settings className="h-5 w-5 inline mr-2" /> Paramètres
            </Link>
            <button onClick={signOut} className="w-full text-left text-red-600 hover:text-red-700">
              <LogOut className="h-5 w-5 inline mr-2" /> Déconnexion
            </button>
          </div>
        </div>
